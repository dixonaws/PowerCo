...
def getAccount(intent, session):
    ...
    # get the invoice details from an API endpoint in our VPC
    ...
    print
    "The amount of the invoice object returned is: " + strAmountDollars

    speech_output = "I found some details for that account. The total amount due is " + strAmountDollars + " dollars."
...
def get_welcome_response():
    ...
    session_attributes = {}
    card_title = "Welcome"
    speech_output = "Hi there! You're on line with PowerCo2! To verify it's you, please say " \
